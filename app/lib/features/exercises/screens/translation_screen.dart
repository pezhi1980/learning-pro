...
class _TranslationScreenState extends State<TranslationScreen> {
  ...
  void _submitAnswer(String targetSentence) {
    ...
    final cleanTarget = targetSentence.replaceAll(RegExp(r"[^\w\s']"), '').toLowerCase().replaceAll(RegExp(r'\s+'), ' ');
  ...
  Widget _buildBody() {
    ...
    if (_exercises.isEmpty) return const Center(child: Text('No translation exercises available.', style: TextStyle(color: AppTheme.darkTextSub)));

    final ex = _exercises[_currentIndex];
    final content = ex['content_json'] as Map<String, dynamic>? ?? {};
    final sourceSentence = content['source_sentence'] as String? ?? '';
    final targetSentence = content['target_sentence'] as String? ?? '';
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Type English translation here...',
            ...
            onSubmitted: (_) => _submitAnswer(targetSentence),
          ),
          ...
          if (!_isAnswered)
            SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed: () => _submitAnswer(targetSentence),
          ...
          if (_isAnswered) ...[
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Target Translation: $targetSentence',
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: const Text('Next Translation'),
                style: ElevatedButton.styleFrom(
                  backgroundColor: _levelColor,
                  foregroundColor: Colors.white,
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),

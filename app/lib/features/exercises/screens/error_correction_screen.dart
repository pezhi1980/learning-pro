...
class _ErrorCorrectionScreenState extends State<ErrorCorrectionScreen> {
  ...
  void _submitAnswer(String correctSentence) {
    ...
    final cleanInput = userInput.replaceAll(RegExp(r"[^\w\s']"), '').toLowerCase().replaceAll(RegExp(r'\s+'), ' ');
    final cleanTarget = correctSentence.replaceAll(RegExp(r"[^\w\s']"), '').toLowerCase().replaceAll(RegExp(r'\s+'), ' ');

    final isCorrect = cleanInput == cleanTarget;
  ...
  Widget _buildBody() {
    ...
    final incorrectSentence = content['incorrect_sentence'] as String? ?? '';
    final correctSentence = content['correct_sentence'] as String? ?? '';
        ...
        children: [
              ...
              children: [
                const Row(
                  children: [
                    ...
                    SizedBox(width: 8),
                    Text('Find and correct the grammar mistake:', style: TextStyle(fontFamily: 'Outfit', fontSize: 12, color: AppTheme.accentAmber, fontWeight: FontWeight.w600)),
                  ],
                ),
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      const Icon(Icons.error_outline_rounded, color: AppTheme.colorError, size: 20),
                      ...
                      Expanded(
                        child: Text(
                          ...
                          style: const TextStyle(
                            ...
                            decorationColor: AppTheme.colorError,
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: 'Type the correct sentence here...',
            ...
            onSubmitted: (_) => _submitAnswer(correctSentence),
          ),
          ...
          if (!_isAnswered)
            SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed: () => _submitAnswer(correctSentence),
                icon: const Icon(Icons.check_circle_rounded),
                label: const Text('Check Correction'),
